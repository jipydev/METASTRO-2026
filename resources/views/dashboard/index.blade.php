        ...
        <div class="p-4 md:p-8 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mt-2">
            ...
            <div
                ...
                @forelse($pengumumanList as $item)
                    ...
                    <div
                        class="bg-white dark:bg-slate-800/90 rounded-2xl border border-gray-200 dark:border-slate-700/80 shadow-sm p-6 mb-5 relative overflow-hidden">
                        {{-- Accent bar --}}
                        ...
                        <div class="pl-2">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <div
                                        class="mt-1.5 flex flex-wrap items-center gap-2 text-sm text-gray-500 dark:text-slate-400">
                                ...
                                <div class="flex items-center gap-2">
                                    @if ($item->status == 'Publish')
                                        <span
                                            class="bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 px-3 py-1 rounded-full text-xs font-semibold">
                                            Publish
                                        </span>
                                    @else
                                        <span
                                            class="bg-amber-50 dark:bg-amber-950/60 border border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-300 px-3 py-1 rounded-full text-xs font-semibold">
                                            Draft
                                        </span>
                                    @endif
                                </div>
                            ...
                            <div class="mt-4">
                                <p
                                    class="whitespace-pre-line text-sm md:text-base leading-relaxed text-gray-700 dark:text-slate-300">
                                    {{ $item->isi }}
                                </p>
                            </div>
            ...
            <div
                ...
                <div>
                    <h2 class="text-primary-600 dark:text-primary-400 font-bold text-lg md:text-xl mb-1">Presensi Rapat
                        Besar</h2>
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-slate-700 dark:text-slate-300">pukul
                ...
                <form action="{{ route('notulensi.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        <div class="mt-3 text-center sm:mt-5">
                            <h3 class="text-lg font-bold leading-6 text-primary-600 dark:text-primary-400"
                                id="modal-title">Tambah Notulensi</h3>
                            <div class="mt-6 text-left">
                                <!-- Input Judul -->
                                <div class="mb-5">
                                    <label
                                        class="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Judul</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="mt-1.5 text-xs text-slate-500 dark:text-slate-400 font-medium">Format:
                                        PDF (Maks 5MB)</p>
                                </div>
                            </div>
                        </div>
