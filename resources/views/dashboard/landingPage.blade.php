...
<head>
    ...
    <meta name="description" content="Portal Resmi METASTRO 2026 - Spirit of Hiro, Heart of Solder. Website resmi dan portal login panitia METASTRO 2026.">
    <title>Landing Page - METASTRO 2026</title>
    
    <!-- Preload & Fonts -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link rel="preload" as="image" href="{{ asset('images/background-metastro.webp') }}" type="image/webp">
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Oswald:wght@700&family=Libre+Caslon+Text:wght@400;700&family=Open+Sans:wght@700&display=swap">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Oswald:wght@700&family=Libre+Caslon+Text:wght@400;700&family=Open+Sans:wght@700&display=swap" media="print" onload="this.media='all'">
    <noscript>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Oswald:wght@700&family=Libre+Caslon+Text:wght@400;700&family=Open+Sans:wght@700&display=swap">
    </noscript>
...
<body class="bg-landing min-h-screen w-full flex flex-col justify-between overflow-x-hidden relative">
    ...
    <main class="min-h-screen w-full flex flex-col justify-between overflow-x-hidden relative">
