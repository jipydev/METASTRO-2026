        ...
        <form
            ...
            <div class="p-6 space-y-5 overflow-y-auto flex-1 text-slate-800 dark:text-slate-200">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 dark:text-slate-500 mt-1.5">Maksimal 5 MB (Format: PDF, Gambar, Doc)</p>
            ...
            <div class="border-t border-gray-100 dark:border-slate-700 px-6 py-4 flex justify-end gap-3 shrink-0">
                ...
                <button
                    type="submit"
                    class="bg-primary-500 hover:bg-primary-600 text-white px-6 py-2 rounded-xl font-bold text-sm shadow-sm cursor-pointer">
                    Simpan
                </button>
            </div>
