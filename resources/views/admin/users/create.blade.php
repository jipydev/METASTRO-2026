                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-5 text-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
                        ...
                        <div>
                            ...
                            <select id="divisi_id" name="divisi_id" class="w-full bg-slate-50 dark:bg-slate-700/60 border border-gray-300 dark:border-slate-600 rounded-xl py-2.5 px-3 text-xs text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-500">
                        ...
                        <div>
                            ...
                            <select id="jabatan_id" name="jabatan_id" class="w-full bg-slate-50 dark:bg-slate-700/60 border border-gray-300 dark:border-slate-600 rounded-xl py-2.5 px-3 text-xs text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-brand-500">
